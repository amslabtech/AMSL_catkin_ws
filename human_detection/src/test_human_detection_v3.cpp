...
{	
	...
	////subscriber////
	ros::Subscriber object_pt_sub = n.subscribe("/cluster/classification/points", 1, ObjectPointCallback);
	ros::Subscriber object_cen_sub = n.subscribe("/cluster/classification/position", 1, ObjectCentroidCallback);
	////publisher////
